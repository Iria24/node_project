...
const updateCerveza = async (req, res) => {
    try {
        ...
        cervezaBody._id = id;
        const updateCerveza = await Cerveza.findByIdAndUpdate(id, cervezaBody, { new: true });
        if (!updateCerveza) {
...
module.exports = { postCerveza, getCerveza, updateCerveza, deleteCerveza, getCervezabyName }
